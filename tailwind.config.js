  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // T-20260630-foot-ASSIGN-ALERT-COMPACT-MONO-VERTICAL AC-3: 담당자 배정 알림 전광판 '세로' 흐름(마키-Y).
        //   복제 라인 2벌(seamless loop)을 -50% 만큼 위로 이동 → 끊김 없는 세로 티커.
        //   (이전 가로 marquee 키프레임 + amber alert-glow 글로우는 본 티켓에서 제거 — 모노톤·세로 전환, 잔재 0.)

...
|---|------|--------------------|-----------|----------------------|-----------|------------------------|------------------|
| 1 | 박소예 | `5c17e4bc-e948-4dc4-a8cf-37904873edeb` | **TRUE ⚠** | `5fb3e3b1-1c5a-461b-9159-c330a52feb95` | y***@gmail.com (staff.active=false / **up.active=true = 로그인 권위**) | **12** (duty_roster.doctor_id 8·package_sessions.performed_by 2·room_assignments.staff_id 2) | **`active IS TRUE`** (활성행 폐기·특수) — FLAG-1 참조 |
| 2 | 장예지 | `a8ffcea8-bbfc-46e7-841b-8192d1d8a3cd` | false | `0237eba4-d347-4251-bd61-32390f197f22` | j***@naver.com (active) | **8** (duty_roster.doctor_id 8) | `active IS NOT TRUE` |
| 3 | 김지혜 | `5f741eba-7397-46ac-979b-11c31fc72eb4` | false | `735dd27a-75de-4599-86e2-9d5d04b64015` | w***@naver.com (active) | **9** (duty_roster.doctor_id 9) | `active IS NOT TRUE` |
| 4 | 서은정 | `42ca1057-06c8-4183-91ab-b9ab5a7c3a26` | false | `1d2165fa-5263-4521-9402-d19b8ceae451` | b***@naver.com (active) | **3** (room_assignments.staff_id 3) | `active IS NOT TRUE` |
| 5 | 김민경 | `3d881cff-40e1-4a1a-9310-5f1482cdd1b8` | false | (email→staff 미해소 — FLAG-2) | a***@naver.com (staff 링크 부재) | **0** (참조 없음 → 재귀속 스킵) | `active IS NOT TRUE` |
| 6 | 정혜인 | `5f141f76-7f72-4560-8a67-bbcdf4938cad` | false | `c851fbb1-31ce-4714-b91c-03e9cb8af566` | 정연주 j***@naver.com (active, reconcile fallback) | **2** (room_assignments.staff_id 2 — id IN [`bd2ff40c…`,`215c9b5b…`]) | `active IS NOT TRUE` |

## ⚠ 집행 전 supervisor/DA 판단 FLAG (dev-foot 결정 안 함 — surface only)

### FLAG-1 (#1 박소예 — confirm 이 DA 데이터신호 제안을 역전, 최중요)
- HOLD 패키지의 DA **제안**은 활성 target(5c17e4bc, 참조多)을 canonical 로 봤으나, **AC-3 confirm(y***@gmail.com)** 은 **로그인 신원 5fb3e3b1**(up.active=true)을 canonical 로 확정. → DA 규칙 ①(활성 신원=로그인 권위 축)에 부합. **폐기 대상은 5c17e4bc**(staff.active=true·user_id=null·12 refs).

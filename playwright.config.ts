  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        // T-20260820-foot-CLOSING-METHODTOTAL-REVBASIS-RESTORE: 합계(결제수단별) per-method 표시축 GROSS→…Rev(revenue-basis)
        //   복원 (DECISION=(A)·REFUND-EXCLUDE supersede). 순수 fs-grep 정적 가드 + sumRev/팬텀쌍 자립 시뮬레이션 —
        //   auth/DB/server/page 불요·결정론. db_change=false·DISPLAY-ONLY. 실 갤탭 수치정합 = 김주연 총괄 field confirm.
        '**/T-20260820-foot-CLOSING-METHODTOTAL-REVBASIS-RESTORE.spec.ts',
      ],
      use: {
    ...
    },
    {
      ...
      testIgnore: [
        ...
        '**/T-20260820-foot-PHOTOUP-CAPTURE-DISCARD-ON-FAIL.spec.ts',
        // T-20260820-foot-CLOSING-METHODTOTAL-REVBASIS-RESTORE: unit 전용 순수 정적 가드 → desktop-chrome(auth/webServer)

  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        // T-20260819-foot-CHARTLOAD-LOADING-STUCK-FIX11A: 차트 초기 로드 IIFE try/catch/finally 정적 회귀 가드
        //   (loading finally 해제 + catch 복구착지). MEDIMG 동일 결함클래스의 loading 누락분. 순수 fs-grep·결정론. db_change=false.
        '**/T-20260819-foot-CHARTLOAD-LOADING-STUCK-FIX11A.spec.ts',

...
- check_ins 642건 중 **실 mutation = 단 1건** → 김OO 중복 6425a5c8 **논리 cancel(status='cancelled')**.
...
- 동명 customer 중복(김규리·김OO·김승현 test-phone)은 **범위 밖** → spinoff 티켓
...
|---|---|---|---|---|
| `6425a5c8-8fb7-46d6-a762-93d9922eeb48` | 김OO (cid 83ab4fe1) | 2026-06-02 | 운영자오류 중복 (차트·결제·서비스·패키지 無) | **status→cancelled (논리 취소)** |
| `207bf234-8851-4a38-8c56-c0191bea96b8` | 김OO (cid 83ab4fe1) | 2026-06-02 | 정본(최초 04:57Z) | **KEEP** |
...
- 동명 customer 중복 3건(김규리 7fa5dff1↔7cef3be8 / 김OO 83ab4fe1↔김구번 오연결 10f10231 / 김승현 fcdcd44f↔53661ce0):
  중복 customer_id가 모두 test-phone([phone-redacted] / [phone-redacted] / [phone-redacted]).
...
2. 부모 UX(우측 초진차트 목록)에서 김OO 중복 노출 1건으로 감소 확인.

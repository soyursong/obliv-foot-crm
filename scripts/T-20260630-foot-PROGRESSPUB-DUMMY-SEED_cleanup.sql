...
-- 김주연 총괄 '경과분석 발행' 테스트 종료 후 더미 환자 3명(테스트경과01/02/03) 일괄삭제.
...
--      AND is_simulation=true AND memo='[TEST-DUMMY PROGRESSPUB 20260701]';
...
-- 검증: 0건이어야 함
-- SELECT count(*) FROM customers WHERE is_simulation=true AND memo='[TEST-DUMMY PROGRESSPUB 20260701]';

...
const FOOT_TID_WHITELIST_DEFAULT = [
  ...
  // 0728 GAP 신 TID(538xxx) — 289006→538239(풋멀티)·288008→538246(풋유선) 재프로비저닝(구 479480·479475 병존, registry superseded_tids 미러):
  "1047538239", "1047538246", // 유선/멀티 4세대(T-20260728-...-0728GAP §11, DA CONSULT-REPLY MSG-20260728-161749-r7wj GO)
];

...
// TID 32종 — 서버-측 tid= narrowing + belt-and-suspenders 보조필터.
//   원 26(구 VAN TID 포함, historical raw 서버-narrowing 무탈락 위해 superset 보존)
//   + 신 6(1047535xxx = 7/23 VAN 재프로비저닝 live TID: 285001→845·002→843·003→842·005→837·006→835·007→797).
//   T-20260724-...-0723GAP Opt-B′: 구·신 TID 병존(registry superseded_tids 미러).
const FOOT_TID_WHITELIST_DEFAULT = [
  ...
  "1047535845", "1047535843", "1047535842", "1047535837", "1047535835", "1047535797", // VAN 신 live(0723 재프로비저닝) 285001·002·003·005·006·007
];

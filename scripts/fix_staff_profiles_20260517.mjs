...
const STAFF_LIST = [
  { email: 'm***@naver.com',    name: '송지현' },
  { email: 'j***@naver.com',      name: '정연주' },
  { email: 'a***@naver.com',     name: '엄경은' },
  { email: 'k***@naver.com',      name: '김수린' },
  { email: 'j***@naver.com',    name: '정혜인' },
  { email: 'j***@naver.com',    name: '박민석' },
  { email: 'a***@naver.com', name: '김민경' },
  { email: 'a***@gmail.com',  name: '김규리' },
  { email: 'b***@naver.com',   name: '백민영' },
  { email: 'b***@gmail.com',     name: '임별'   },
  { email: 'g***@gmail.com',     name: '조선미' },
  { email: 's***@naver.com',    name: '김성우' },
  { email: 'k***@naver.com',name: '강혜인' },
  { email: 'c***@naver.com',  name: '최다혜' },
  { email: 'm***@naver.com',    name: '최민지' },
  { email: 'm***@naver.com',     name: '윤시하' },
  { email: '0***@hanmail.net', name: '김유리' },
  { email: 'b***@naver.com',     name: '서은정' },
];

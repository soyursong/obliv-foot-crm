...
const BASELINE = 169100; // 07-15 canonical (payments net + package_payments net + closing_manual)
...
// ══ 요약 ════════════════════════════════════════════════════════════════════════
say('\n════════ C1~C8 요약 ════════');
const passed = ['C1', 'C2', 'C3', 'C4', 'C5①', 'C5②', 'C5③', 'C6', 'C7', 'C8'].filter((c) => !fail.includes(c));
say(`  PASS ${passed.length}/10 : ${passed.join(' ')}`);

/**
 * 풋센터 CRM 더미 데이터 정리 — 6/2 테스트 롤백
 *
 * 삭제 대상:
 *   - is_simulation=true + phone IN (+821099080001 ~ +821099080068) 고객 및 연관 레코드
...
const TARGET_PHONES = [
  ...
  ...Array.from({ length: 34 }, (_, i) => `+821099080${String(i + 1).padStart(3, '0')}`),
  // 재진(색깔) +821099080035 ~ +821099080068
  ...Array.from({ length: 34 }, (_, i) => `+821099080${String(35 + i).padStart(3, '0')}`),
];
...
async function main() {
  console.log('🗑️  더미 데이터 정리 시작 (6/2 테스트 롤백)');

...
// T-20260706-foot-DOCFORM-CATEGORY-RELABEL-ROLLBACK: '제증명' 카테고리 정식화(신설).
//   서류 제증명 6종(진단서/소견서 국·영, 통원확인서, 진료기록사본) + 무료 4종
//   (영수증·세부내역서·KOH결과지·처방전)이 이미 DB에 category_label='제증명'
//   (Migration B, 20260630140000)로 귀속돼 있으나, 이 배열에 '제증명'이 누락되어
//   서비스관리 탭/항목분류 옵션에 그룹이 렌더되지 않던 상태. '처방약' 선례와 동일하게
//   배열에 '제증명' 추가만으로 노출 복구(데이터 임의 매핑 없음·미러 insert 없음·'기본' 원복 없음).

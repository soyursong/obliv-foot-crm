 ...
 * T-20260702-foot-RESVAXIS-RIBON-LABEL: 리본 라벨 3차 변경(§13.1.A REDEFINITION) —
 *   김주연 총괄 직접 지시로 '리본(발각질)' → '[리본]' 확정. abbr '리'·초/재/힐 라벨·카운트 소스 불변.
 * T-20260702-foot-RESVAXIS-RIBON-DEBRACKET: 리본 라벨 4차 변경(§13.1.A REDEFINITION, reporter-authorized) —
 *   김주연 총괄 직접 지시로 '[리본]' → '리본' 확정(대괄호 제거·텍스트 '리본' 유지). abbr '리'·초/재/힐 라벨·카운트 소스 불변.
 */
export const RIBBON_BADGE_LABEL = '리본';
 ...
 */
export function isBriefNoteChip(brief_note?: string | null): brief_note is string {

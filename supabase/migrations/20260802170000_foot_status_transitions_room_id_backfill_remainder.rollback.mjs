/**
 * T-20260802-foot-ST-ROOMID-FILL — 잔여 백필 ROLLBACK
 *
 * archive JSON(T-20260802-foot-ST-ROOMID-FILL_freeze_archive.json)의 정확 id-set 만
 *   room_id → NULL 복원. 본 백필분(freeze-set)만 대상 —
 *   캡처가 채운 신규 전이 · 기존 60일 백필(T-20260725)분은 archive 에 없어 무접촉.
 *   안전 가드: 현재 값이 백필한 값과 동일할 때만 NULL (그 사이 수동 변경분 보호).
 * 실행: node supabase/migrations/20260802170000_foot_status_transitions_room_id_backfill_remainder.rollback.mjs
 */

-- ROLLBACK for 20260713120000_selfcheckin_writepath_harden_masked_reject.sql
-- 직전 함수정의(20260617000000_selfcheckin_composite_key_3key) 를 그대로 복원한다.
-- 스키마 무변경(동일 signature CREATE OR REPLACE) → 데이터/스키마 롤백 불필요, 함수 본문만 원복.
-- ticket: T-20260713-foot-UNAUTH-CHANGE-INVESTIGATE-ROLLBACK (WS-A) · author: dev-foot 2026-07-13

...
REVOKE ALL ON FUNCTION public.fn_build_insurance_claim_draft(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.fn_rollup_insurance_claim_drafts(uuid, date, date) FROM PUBLIC;

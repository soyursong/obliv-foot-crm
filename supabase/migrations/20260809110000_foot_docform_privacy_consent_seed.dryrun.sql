-- DRY-RUN (No-Persistence) — T-20260808-foot-PENCHART-PRIVACY-CONSENT-FORM
--   20260809110000_..._seed.sql 의 INSERT 로직을 그대로 실행하되 COMMIT 대신 ROLLBACK.
...
BEGIN
  ...
  RAISE NOTICE '[DRY-RUN] pre-existing privacy_consent_form row: %', v_exists;

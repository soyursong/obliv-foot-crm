-- Rollback: T-20260601-foot-SPACE-ASSIGN-RESET-REGRESS (REOPEN-3)
-- save_room_assignments 함수를 직전(150000) 버전 — INSERT 시 미배정 행 생략 — 으로 되돌린다.
-- 코드(handleSave 미배정 포함)도 함께 revert 해야 정합.

-- ROLLBACK: T-20260622-foot-STATS-MIGRATION-DRIFT-2PHANTOM (AC2 designated on roster)
-- foot_stats_therapist_summary 를 적용 직전 LIVE(20260622120000_staff_source_filter) 7컬럼 roster 정의로 복원.
-- = designated 3컬럼 제거, roster/laser-end/정밀매칭 그대로.

-- DRY-RUN (No-Persistence Protocol) — T-20260730-foot-RRN-CLIPBOARD-COPY-NHIS 클립보드 반출 감사 RPC
--
...
--   2) 시그니처 = log_rrn_clipboard_copy(uuid) RETURNS void              → PASS
...
--   SELECT count(*) FROM pg_proc WHERE proname='log_rrn_clipboard_copy';   -- 기대 0(미영속)
--

...
Deno.serve(async (req) => {
  ...
  const supabaseServiceKey = Deno.env.get('FOOT_SB_SECRET_KEY') ?? Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')!; // [SVCKEY-ROTATE] 신형 sb_secret 우선, legacy service_role fallback (무중단 cutover)

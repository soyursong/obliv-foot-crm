...
priority: P1
status: deploy-ready
deploy_ready_at: 2026-05-29 08:40
commit_sha: 00339cd
db_changed: true
...
- 시드 스크립트: `scripts/seed_testdata_20260529.mjs`
- 롤백 스크립트: `scripts/rollback_testdata_20260529.mjs`
...
- [x] AC-5: 롤백 스크립트 `scripts/rollback_testdata_20260529.mjs` 구현

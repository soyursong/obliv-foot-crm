...
## 검증
- `npm run build` (tsc -b + vite) ✅ 통과 (noUnusedLocals strict)
- 신규 E2E `tests/e2e/T-20260605-foot-RX-PHRASE-INSERT-UX.spec.ts` — 17/17 passed (AC-1~5 + 현장 시나리오 3종: 인라인 ✓ 즉시삽입 / 행 전환 / GUARD 회귀)

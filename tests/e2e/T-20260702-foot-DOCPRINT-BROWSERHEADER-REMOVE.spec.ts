...
const PAD_TOP = 16, PAD_LR = 10, PAD_BOT = 12; // .page padding = 구 @page 물리여백 (VSPACE-ADJUST: 상단 23→16mm)
...
async function measure(page: import('@playwright/test').Page, formKey: string, orient: 'portrait' | 'landscape') {
  ...
  expect(topMm, `${formKey} 상단 ~16mm 하향(VSPACE-ADJUST, 쏠림 없음)`).toBeGreaterThan(13);

...
const FOOT_TIDS = [
  ...
  // 0725 GAP 신 TID(538xxx): 289003→538235·289008→538245 (멀티, T-20260727-...-0725GAP)
  '1047538235','1047538245',
];
...
test.describe('T-20260725-EXPAND0723-8LOCI · poller/plist DEFAULT 285002 parity(staleness-seal)', () => {
  ...
  test('poller FOOT_TID_WHITELIST_DEFAULT = 0723GAP(535xxx) ∪ 0724GAP(538xxx) additive 결합', () => {
    ...
    // 0725GAP 2 신 멀티 TID (289003→538235·289008→538245, 역회귀 방지)
    for (const t of ['1047538235', '1047538245']) {
      expect(body).toContain(`"${t}"`);
    }
  });

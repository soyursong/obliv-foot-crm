...
//   guard(assertCriticalFlowDbSafe)는 fail-closed belt 로 존치 — dev DB(=skip false)에선 정상 실행돼
//   회귀 detection 복원. dev-isolation=T-20260804-foot-FOOTCTR-E2E-DEVDB-ISOLATION-CUTOVER.
test.skip(
...
test.beforeAll(() => assertCriticalFlowDbSafe('CF-1-new-patient-full-cycle'));

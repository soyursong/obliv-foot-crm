...
// 내비게이션은 상대경로('/')로만 — playwright.config 의 baseURL(webServer 포트)을 그대로 따른다.
// (절대 URL + 5173 fallback 은 webServer 가 8089 로 뜨는 환경에서 ERR_CONNECTION_REFUSED 를 유발,
//  PLAYWRIGHT_BASE_URL env 미설정 시 false 재현 위험 → 최근 spec 관례인 상대 goto 로 통일.)

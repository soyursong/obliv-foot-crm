...
test('S2-2: use-time 진료의 수동 조정 가능 — formRx 의 용량/횟수/일수 편집 UI 존속(잠금 아님)', () => {
  const src = read(MEDCHART);
  // baked default 가 흡수된 뒤에도 차트에서 dosage/count/days 를 수정할 수 있어야 함
